...
uses
  ...
  ACBrAPIClient, ACBrAPIDtos, OpenApiRest, Vcl.StdCtrls, Vcl.ExtCtrls, Vcl.ComCtrls;
...
type
  ...
  public
    class procedure Editar(Client: IACBrAPIClient; const Cnpj: string);
  end;
...
class procedure TfmConfigNfse.Editar(Client: IACBrAPIClient; const Cnpj: string);
var
  Form: TfmConfigNfse;
begin
