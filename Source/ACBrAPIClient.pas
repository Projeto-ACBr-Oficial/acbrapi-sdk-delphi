...
type
  ...
  TNfeService = class;
  TNfseService = class;
  TACBrAPIConfig = class;
  TACBrAPIClient = class;
  ...
  TACBrAPIConfig = class(TCustomRestConfig)
  public
    constructor Create;
  end;
  
  IACBrAPIClient = interface(IRestClient)
  ...
  TACBrAPIClient = class(TCustomRestClient, IACBrAPIClient)
  public
    function Cep: ICepService;
    function Cnpj: ICnpjService;
    function Conta: IContaService;
...
function TACBrAPIClient.Cep: ICepService;
begin
  Result := TCepService.Create(Config);
end;

function TACBrAPIClient.Cnpj: ICnpjService;
begin
  Result := TCnpjService.Create(Config);
end;

function TACBrAPIClient.Conta: IContaService;
begin
  Result := TContaService.Create(Config);
end;

function TACBrAPIClient.Cte: ICteService;
begin
  Result := TCteService.Create(Config);
end;

function TACBrAPIClient.CteOs: ICteOsService;
begin
  Result := TCteOsService.Create(Config);
end;

function TACBrAPIClient.Dce: IDceService;
begin
  Result := TDceService.Create(Config);
end;

function TACBrAPIClient.Debug: IDebugService;
begin
  Result := TDebugService.Create(Config);
end;

function TACBrAPIClient.DistribuiçãoNFE: IDistribuiçãoNFEService;
begin
  Result := TDistribuiçãoNFEService.Create(Config);
end;

function TACBrAPIClient.Email: IEmailService;
begin
  Result := TEmailService.Create(Config);
end;

function TACBrAPIClient.Empresa: IEmpresaService;
begin
  Result := TEmpresaService.Create(Config);
end;

function TACBrAPIClient.Mdfe: IMdfeService;
begin
  Result := TMdfeService.Create(Config);
end;

function TACBrAPIClient.Nfce: INfceService;
begin
  Result := TNfceService.Create(Config);
end;

function TACBrAPIClient.Nfcom: INfcomService;
begin
  Result := TNfcomService.Create(Config);
end;

function TACBrAPIClient.Nfe: INfeService;
begin
  Result := TNfeService.Create(Config);
end;

function TACBrAPIClient.Nfse: INfseService;
begin
  Result := TNfseService.Create(Config);
end;

constructor TACBrAPIClient.Create;
begin
  inherited Create(TACBrAPIConfig.Create);
end;
